...
var venus = new Planet( 12_104, 4.87, 108.2, 224.7, -5832.5);
var earth = new Planet(12_756, 5.97, 149.6, 365.2, 23.9);
var mars = new Planet(6792, 0.642, 227.9, 687.0, 24.6);
var jupiter = new Planet(142_984, 1898, 778.6, 4331, 9.9);
var saturn = new Planet(120_536, 658, 1433.5, 10_747, 10.7);
var uranus = new Planet(51_118, 86.8, 2872.5, 30_589, -17.2);
var neptune = new Planet(49_528, 102, 4495.1, 59_800, 16.1);
var pluto = new Planet(2390, 0.0131, 5870.0, 90_588, -153.3);
